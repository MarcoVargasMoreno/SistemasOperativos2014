...
public class Ventana extends javax.swing.JFrame {
    ...
    private class Hilo implements Runnable {
        ...
        public void run() {
            while (true) {
                try{ // este tray evita el error al abrir el formulario y no se le digite algun valor a ls cajas de texto
                int numero1 = Integer.parseInt(JTFNum1.getText());
                int numero2 = Integer.parseInt(JTFNum2.getText());
                if (numero1 > numero2) {
                    JOptionPane.showMessageDialog(null, "El Numero1 es mayor al Numero2");
                }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(JTFNum1, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE)
